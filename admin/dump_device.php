 ...
 <div class="container-fluid">
   ...
   <div class="empty">
	   <div class="pull-right">
	   	...
	   	<a href="export_to_excel.php" class="btn btn-info" id="print" data-placement="left" title="Click to Export"><i style="background-color: green" class="fa fa-file-excel-o"></i> Export To Excel </a>  

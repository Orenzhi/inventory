									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
										...
										<div class="control-group">
											<label class="control-label" for="inputEmail">Device Number</label>
											<div class="controls">			
												<input type="text"  value="<?php echo $row['dev_serial']; ?>" name="dev_serial" id="inputPassword" placeholder="New code" required>
											</div></br>
